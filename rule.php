...
class quizaccess_safeexambrowser extends quiz_access_rule_base {
     ...
     * @return string the message saying to use secure browser.
     */
    ...
    /**
     * Generate and return a SEB config link.
     * @param string $examconfig the exam config.
     * @return string the link to start the exam.
     */
     ...
     * @param array $bekeys allowed keys
